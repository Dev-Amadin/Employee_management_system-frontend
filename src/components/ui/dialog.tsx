            ...
            render={
              <Button
                ...
                className="absolute top-2 right-2 p-2 rounded-full hover:cursor-pointer
                 hover:bg-purple-accent/10 transition-colors duration-300"
                size="icon-lg"
              />
            }
          >
...
function DialogFooter({
  ...
  return (
    ...
    >
      {children}
      {showCloseButton && (
        <DialogPrimitive.Close render={<Button variant="destructive" />}
        >
          Close
        </DialogPrimitive.Close>
      )}
