...
function FieldLabel({
  ...
  return (
    <Label
      ...
      className={cn(
        "group/field-label peer/field-label flex w-fit gap-2 leading-snug group-data-[disabled=true]/field:opacity-50 has-data-checked:bg-oklch(0.205 0 0)/5 has-[>[data-slot=field]]:rounded-md has-[>[data-slot=field]]:border *:data-[slot=field]:p-2 dark:has-data-checked:bg-oklch(0.205 0 0)/10 dark:has-data-checked:bg-oklch(0.922 0 0)/5 dark:dark:has-data-checked:bg-oklch(0.922 0 0)/10",
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn("text-xs/relaxed font-normal text-oklch(0.577 0.245 27.325) dark:text-oklch(0.704 0.191 22.216)", className)}
      {...props}
    >
      {content}
    </div>
